...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://formsubmit.co/ajax/isiyejoshua@gmail.com', {
        method: 'POST',
        headers: {
...
//   useEffect(() => {
//     if (recaptchaLoaded && window.grecaptcha && !recaptchaToken) {
//       const siteKey = import.meta.env.VITE_RECAPTCHA_SITE_KEY || '6LfMbsgsAAAAACrOg8tDXd3R6CNuHoUfwlr4myQw';
...
//           _replyto: formData.email,
//           _template: 'table',
//           _captcha: 'false', // We're using our own reCAPTCHA
//           'g-recaptcha-response': recaptchaToken // Send token to backend
//         })
//       });
...
//                 <p className="text-red-400 text-xs text-center">Please complete the reCAPTCHA verification</p>
//               )}

//               {/* Hidden fields for FormSubmit */}
//               <input type="hidden" name="_subject" value="New Quote Request - FRAROB Investment Limited" />
